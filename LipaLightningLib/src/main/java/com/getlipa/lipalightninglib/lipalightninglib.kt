...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_lipalightninglib_1457_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_lipalightninglib_1457_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_lipalightninglib_1457_LightningNode_object_free(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_1457_LightningNode_new(`config`: RustBuffer.ByValue,`eventsCallback`: Long,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun lipalightninglib_1457_LightningNode_get_node_info(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_query_lsp_fee(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_calculate_lsp_fee(`ptr`: Pointer,`amountMsat`: Long,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun lipalightninglib_1457_LightningNode_create_invoice(`ptr`: Pointer,`amountMsat`: Long,`description`: RustBuffer.ByValue,`metadata`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_decode_invoice(`ptr`: Pointer,`invoice`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_pay_invoice(`ptr`: Pointer,`invoice`: RustBuffer.ByValue,`metadata`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_1457_LightningNode_get_latest_payments(`ptr`: Pointer,`numberOfPayments`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_get_payment(`ptr`: Pointer,`hash`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_foreground(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_1457_LightningNode_background(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_1457_LightningNode_list_currency_codes(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_get_exchange_rates(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_LightningNode_change_fiat_currency(`ptr`: Pointer,`fiatCurrency`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_1457_LightningNode_change_timezone_config(`ptr`: Pointer,`timezoneConfig`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_lipalightninglib_1457_EventsCallback_init_callback(`callbackStub`: ForeignCallback,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_1457_init_native_logger_once(`minLevel`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_1457_generate_secret(`passphrase`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_mnemonic_to_secret(`mnemonicString`: RustBuffer.ByValue,`passphrase`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_words_by_prefix(`prefix`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_1457_recover_lightning_node(`seed`: RustBuffer.ByValue,`localPersistencePath`: RustBuffer.ByValue,`graphqlUrl`: RustBuffer.ByValue,`backendHealthUrl`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_lipalightninglib_1457_rustbuffer_alloc(`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_lipalightninglib_1457_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_lipalightninglib_1457_rustbuffer_free(`buf`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_lipalightninglib_1457_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
class LightningNode(
    ...
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_new(FfiConverterTypeConfig.lower(`config`), FfiConverterTypeEventsCallback.lower(`eventsCallback`), _status)
})
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_lipalightninglib_1457_LightningNode_object_free(this.pointer, status)
        }
    }
    ...
    override fun `getNodeInfo`(): NodeInfo =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_get_node_info(it,  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `queryLspFee`(): LspFee =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_query_lsp_fee(it,  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `calculateLspFee`(`amountMsat`: ULong): ULong =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_calculate_lsp_fee(it, FfiConverterULong.lower(`amountMsat`),  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `createInvoice`(`amountMsat`: ULong, `description`: String, `metadata`: String): InvoiceDetails =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_create_invoice(it, FfiConverterULong.lower(`amountMsat`), FfiConverterString.lower(`description`), FfiConverterString.lower(`metadata`),  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `decodeInvoice`(`invoice`: String): InvoiceDetails =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_decode_invoice(it, FfiConverterString.lower(`invoice`),  _status)
}
        }.let {
            FfiConverterTypeInvoiceDetails.lift(it)
        }
    ...
    @Throws(LnException::class)override fun `payInvoice`(`invoice`: String, `metadata`: String) =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_pay_invoice(it, FfiConverterString.lower(`invoice`), FfiConverterString.lower(`metadata`),  _status)
}
        }
    ...
    @Throws(LnException::class)override fun `getLatestPayments`(`numberOfPayments`: UInt): List<Payment> =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_get_latest_payments(it, FfiConverterUInt.lower(`numberOfPayments`),  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `getPayment`(`hash`: String): Payment =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_get_payment(it, FfiConverterString.lower(`hash`),  _status)
}
        }.let {
    ...
    override fun `foreground`() =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_foreground(it,  _status)
}
        }
    ...
    override fun `background`() =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_background(it,  _status)
}
        }
    ...
    @Throws(LnException::class)override fun `listCurrencyCodes`(): List<String> =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_list_currency_codes(it,  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `getExchangeRates`(): ExchangeRates =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_get_exchange_rates(it,  _status)
}
        }.let {
    ...
    override fun `changeFiatCurrency`(`fiatCurrency`: String) =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_change_fiat_currency(it, FfiConverterString.lower(`fiatCurrency`),  _status)
}
        }
    ...
    override fun `changeTimezoneConfig`(`timezoneConfig`: TzConfig) =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_LightningNode_change_timezone_config(it, FfiConverterTypeTzConfig.lower(`timezoneConfig`),  _status)
}
        }
...
enum class RuntimeErrorCode {
    ESPLORA_SERVICE_UNAVAILABLE,EXCHANGE_RATE_PROVIDER_UNAVAILABLE,LSP_SERVICE_UNAVAILABLE,REMOTE_STORAGE_ERROR,RGS_SERVICE_UNAVAILABLE,RGS_UPDATE_ERROR,OBJECT_NOT_FOUND,NON_EXISTING_WALLET,ALREADY_USED_INVOICE,PAYING_TO_SELF,NO_ROUTE_FOUND,SEND_FAILURE,GENERIC_ERROR;
}
...
public object FfiConverterTypeEventsCallback: FfiConverterCallbackInterface<EventsCallback>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_lipalightninglib_1457_EventsCallback_init_callback(this.foreignCallback, status)
        }
    }
}
...
fun `initNativeLoggerOnce`(`minLevel`: LogLevel) =
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_init_native_logger_once(FfiConverterTypeLogLevel.lower(`minLevel`), _status)
}
...
fun `generateSecret`(`passphrase`: String): Secret {
    ...
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_generate_secret(FfiConverterString.lower(`passphrase`), _status)
})
}
...
fun `mnemonicToSecret`(`mnemonicString`: List<String>, `passphrase`: String): Secret {
    return FfiConverterTypeSecret.lift(
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_mnemonic_to_secret(FfiConverterSequenceString.lower(`mnemonicString`), FfiConverterString.lower(`passphrase`), _status)
})
}
...
fun `wordsByPrefix`(`prefix`: String): List<String> {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_words_by_prefix(FfiConverterString.lower(`prefix`), _status)
})
}
...
fun `recoverLightningNode`(`seed`: List<UByte>, `localPersistencePath`: String, `graphqlUrl`: String, `backendHealthUrl`: String) =
    ...
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_1457_recover_lightning_node(FfiConverterSequenceUByte.lower(`seed`), FfiConverterString.lower(`localPersistencePath`), FfiConverterString.lower(`graphqlUrl`), FfiConverterString.lower(`backendHealthUrl`), _status)
}
