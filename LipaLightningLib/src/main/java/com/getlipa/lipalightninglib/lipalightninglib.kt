...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_lipalightninglib_5383_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_lipalightninglib_5383_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_lipalightninglib_5383_LightningNode_object_free(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_LightningNode_new(`config`: RustBuffer.ByValue,`eventsCallback`: Long,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun lipalightninglib_5383_LightningNode_get_node_info(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_query_lsp_fee(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_calculate_lsp_fee(`ptr`: Pointer,`amountMsat`: Long,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun lipalightninglib_5383_LightningNode_create_invoice(`ptr`: Pointer,`amountMsat`: Long,`description`: RustBuffer.ByValue,`metadata`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_decode_invoice(`ptr`: Pointer,`invoice`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_pay_invoice(`ptr`: Pointer,`invoice`: RustBuffer.ByValue,`metadata`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_LightningNode_pay_open_invoice(`ptr`: Pointer,`invoice`: RustBuffer.ByValue,`amountMsat`: Long,`metadata`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_LightningNode_get_latest_payments(`ptr`: Pointer,`numberOfPayments`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_get_payment(`ptr`: Pointer,`hash`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_foreground(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_LightningNode_background(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_LightningNode_list_currency_codes(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_get_exchange_rate(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_LightningNode_change_fiat_currency(`ptr`: Pointer,`fiatCurrency`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_LightningNode_change_timezone_config(`ptr`: Pointer,`timezoneConfig`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_lipalightninglib_5383_EventsCallback_init_callback(`callbackStub`: ForeignCallback,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_init_native_logger_once(`minLevel`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_generate_secret(`passphrase`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_mnemonic_to_secret(`mnemonicString`: RustBuffer.ByValue,`passphrase`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_words_by_prefix(`prefix`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun lipalightninglib_5383_accept_terms_and_conditions(`environment`: RustBuffer.ByValue,`seed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun lipalightninglib_5383_recover_lightning_node(`environment`: RustBuffer.ByValue,`seed`: RustBuffer.ByValue,`localPersistencePath`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_lipalightninglib_5383_rustbuffer_alloc(`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_lipalightninglib_5383_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_lipalightninglib_5383_rustbuffer_free(`buf`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_lipalightninglib_5383_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
class LightningNode(
    ...
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_new(FfiConverterTypeConfig.lower(`config`), FfiConverterTypeEventsCallback.lower(`eventsCallback`), _status)
})
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_lipalightninglib_5383_LightningNode_object_free(this.pointer, status)
        }
    }
    ...
    override fun `getNodeInfo`(): NodeInfo =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_get_node_info(it,  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `queryLspFee`(): LspFee =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_query_lsp_fee(it,  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `calculateLspFee`(`amountMsat`: ULong): ULong =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_calculate_lsp_fee(it, FfiConverterULong.lower(`amountMsat`),  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `createInvoice`(`amountMsat`: ULong, `description`: String, `metadata`: String): InvoiceDetails =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_create_invoice(it, FfiConverterULong.lower(`amountMsat`), FfiConverterString.lower(`description`), FfiConverterString.lower(`metadata`),  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `decodeInvoice`(`invoice`: String): InvoiceDetails =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_decode_invoice(it, FfiConverterString.lower(`invoice`),  _status)
}
        }.let {
            FfiConverterTypeInvoiceDetails.lift(it)
        }
    ...
    @Throws(LnException::class)override fun `payInvoice`(`invoice`: String, `metadata`: String) =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_pay_invoice(it, FfiConverterString.lower(`invoice`), FfiConverterString.lower(`metadata`),  _status)
}
        }
    ...
    @Throws(LnException::class)override fun `payOpenInvoice`(`invoice`: String, `amountMsat`: ULong, `metadata`: String) =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_pay_open_invoice(it, FfiConverterString.lower(`invoice`), FfiConverterULong.lower(`amountMsat`), FfiConverterString.lower(`metadata`),  _status)
}
        }
    ...
    @Throws(LnException::class)override fun `getLatestPayments`(`numberOfPayments`: UInt): List<Payment> =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_get_latest_payments(it, FfiConverterUInt.lower(`numberOfPayments`),  _status)
}
        }.let {
    ...
    @Throws(LnException::class)override fun `getPayment`(`hash`: String): Payment =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_get_payment(it, FfiConverterString.lower(`hash`),  _status)
}
        }.let {
    ...
    override fun `foreground`() =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_foreground(it,  _status)
}
        }
    ...
    override fun `background`() =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_background(it,  _status)
}
        }
    ...
    @Throws(LnException::class)override fun `listCurrencyCodes`(): List<String> =
        callWithPointer {
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_list_currency_codes(it,  _status)
}
        }.let {
    ...
    override fun `getExchangeRate`(): ExchangeRate? =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_get_exchange_rate(it,  _status)
}
        }.let {
    ...
    override fun `changeFiatCurrency`(`fiatCurrency`: String) =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_change_fiat_currency(it, FfiConverterString.lower(`fiatCurrency`),  _status)
}
        }
    ...
    override fun `changeTimezoneConfig`(`timezoneConfig`: TzConfig) =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_LightningNode_change_timezone_config(it, FfiConverterTypeTzConfig.lower(`timezoneConfig`),  _status)
}
        }
...
public object FfiConverterTypeEventsCallback: FfiConverterCallbackInterface<EventsCallback>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_lipalightninglib_5383_EventsCallback_init_callback(this.foreignCallback, status)
        }
    }
}
...
fun `initNativeLoggerOnce`(`minLevel`: LogLevel) =
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_init_native_logger_once(FfiConverterTypeLogLevel.lower(`minLevel`), _status)
}
...
fun `generateSecret`(`passphrase`: String): Secret {
    ...
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_generate_secret(FfiConverterString.lower(`passphrase`), _status)
})
}
...
fun `mnemonicToSecret`(`mnemonicString`: List<String>, `passphrase`: String): Secret {
    return FfiConverterTypeSecret.lift(
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_mnemonic_to_secret(FfiConverterSequenceString.lower(`mnemonicString`), FfiConverterString.lower(`passphrase`), _status)
})
}
...
fun `wordsByPrefix`(`prefix`: String): List<String> {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_words_by_prefix(FfiConverterString.lower(`prefix`), _status)
})
}
...
fun `acceptTermsAndConditions`(`environment`: EnvironmentCode, `seed`: List<UByte>) =
    ...
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_accept_terms_and_conditions(FfiConverterTypeEnvironmentCode.lower(`environment`), FfiConverterSequenceUByte.lower(`seed`), _status)
}
...
fun `recoverLightningNode`(`environment`: EnvironmentCode, `seed`: List<UByte>, `localPersistencePath`: String) =
    ...
    rustCallWithError(LnException) { _status ->
    _UniFFILib.INSTANCE.lipalightninglib_5383_recover_lightning_node(FfiConverterTypeEnvironmentCode.lower(`environment`), FfiConverterSequenceUByte.lower(`seed`), FfiConverterString.lower(`localPersistencePath`), _status)
}
